...
# head = convert([1, 2, 3, 2, 1])
# print_linked_list(remove(head, 2))

head = convert([1, 2, 3, 3, 3])
print_linked_list(remove(head, 3))

head = convert([1])
print_linked_list(remove(head, 5))

head = convert([5, 5, 5, 4, 5, 5, 5])
print_linked_list(remove(head, 5))
