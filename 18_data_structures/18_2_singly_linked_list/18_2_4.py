...
head = Node(1)
print_linked_list(insert(head, 0))

head = Node(1, Node(3, Node(4, Node(5))))
print_linked_list(insert(head, 2))

head = Node(-5, Node(-4, Node(-3, Node(-2))))
print_linked_list(insert(head, -1))
