...
head = convert(list(range(10**4)))
print_linked_list(rotate(head, 10**8))

head = Node(-3, Node(2, Node(0, Node(1, Node(8)))))
print_linked_list(rotate(head, 9))

head = Node(1, Node(2, Node(3, Node(4, Node(5)))))
print_linked_list(rotate(head, 4))
