...
print_linked_list(remove_prev_to_last(head))  # 1 2 3 5

head = Node(-3, Node(-7))
print_linked_list(remove_prev_to_last(head))  # -7

head = Node(5, Node(5, Node(5, Node(5, Node(5)))))
print_linked_list(remove_prev_to_last(head))  # 5 5 5 5

head = Node(5, Node(0, Node(5, Node(-1, Node(7, Node(10, Node(0)))))))
print_linked_list(remove_prev_to_last(head))  # 5 0 5 -1 7 0
